...
import { getRuleEngineLogEventApi } from "../../api's/LogsApi";
...
const RuleEngineLogEvents = () => {
  ...
  const getLogs = async () => {
    setLoadBtn(true);
    const response = await getRuleEngineLogEventApi(params.logstream);
...
export default RuleEngineLogEvents;
