...
import NodeModalWrite from './flow-builder-form/NodeModal_Write';
...
import RealTimeFlowBuilderTop from './RealTimeFlowBuilderTop';
...
const NewFlowBuilderPannel = ({ componentType }) => {
...
export default NewFlowBuilderPannel;
