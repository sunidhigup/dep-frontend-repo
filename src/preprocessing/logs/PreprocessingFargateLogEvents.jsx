...
import { getPreprocessFargateLogEventApi } from "../../api's/LogsApi";
...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  const getLogs = async () => {
    setLoadBtn(true);
    const response = await getPreprocessFargateLogEventApi(params.fargatelogstream);
  ...
  export default PreprocessingLogEvents