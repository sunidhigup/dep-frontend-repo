...
import { getPreprocessLambdaLogEventApi } from "../../api's/LogsApi";
...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  const PreprocessingLambdaLogEvents = () => {
  ...
  const getLogs = async () => {
    ...
    const response = await getPreprocessLambdaLogEventApi(params.logstream);
  ...
  export default PreprocessingLambdaLogEvents