...
import { getPreprocessContentLogEventApi } from "../../api's/LogsApi";
...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  const getLogs = async () => {
    ...
    const response = await getPreprocessContentLogEventApi(params.logstream.split("_pdf")[0]);
  ...
  export default PreprocessingContentLog