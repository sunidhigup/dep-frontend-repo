import {
  ...
  const PreprocessorJobOnBoardStep2 = ({
    tableRule,
    streamId,
    clientId,
    updateFields,
    ...
    const getTableRules = async () => {
      setIsLoad(true);
      setUpdateFields(tableRule[0].fields);
      setIsLoad(false);
    };
    useEffect(() => {
      getTableRules();
          ...
          <Box>
            ...
            >
              ...
              {/* <Tooltip title="Add custom Rule">
                <Button variant="outlined" color="primary" onClick={handleCreateRuleModalOpen}>
              ...
              <Table sx={{ minWidth: 700 }} aria-label="customized table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="center" style={{ backgroundColor: '#0dd398' }}>
                      Field Name
                    </StyledTableCell>
                    <StyledTableCell align="center" style={{ backgroundColor: '#0dd398' }}>
                      Field Type
  ...
  export default PreprocessorJobOnBoardStep2;
