...
const Sales_Approved_users = () => {
    ...
    React.useEffect(() => {
        const getApprovedUsers = async () => {
            let res = await axios.get(`${BASEURL}/salesadmin/approveduserlist`, {
                auth: {
    ...
    const deleteUser = async (e, row) => {
        ...
        let res1 = await axios.delete(`${BASEURL}/salesadmin/deleteuser`, {
            data: {
                email: row.email
            },
            auth: {
        ...
        if (res1.status === 200) {
            ...
            let res2 = await axios.get(`${BASEURL}/salesadmin/approveduserlist`, {
                auth: {
                    username: admin_username,
                    password: admin_password
                }
...
export default Sales_Approved_users